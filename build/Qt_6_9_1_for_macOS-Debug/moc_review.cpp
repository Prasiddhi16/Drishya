...
namespace {
struct qt_meta_tag_ZN6reviewE_t {};
} // unnamed namespace

template <> constexpr inline auto review::qt_create_metaobjectdata<qt_meta_tag_ZN6reviewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_btnCompare_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_btnExper_clicked'
    ...
    return QtMocHelpers::metaObjectData<review, qt_meta_tag_ZN6reviewE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject review::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6reviewE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6reviewE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6reviewE_t>.metaTypes,
    nullptr
} };
...
void *review::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6reviewE_t>.strings))
