...
public:
    ...
    void setupUi(QWidget *expense)
    {
        ...
        expense->resize(846, 599);
        groupBox = new QGroupBox(expense);
        groupBox->setObjectName("groupBox");
        groupBox->setGeometry(QRect(-20, 10, 871, 571));
...
""));
        ...
        label_2->setGeometry(QRect(40, 90, 201, 41));
...
"}"));
        ...
        lineEdit->setGeometry(QRect(260, 90, 271, 41));
...
"    }"));
        ...
        label_3->setGeometry(QRect(40, 170, 221, 41));
...
"}"));
        ...
        label_4->setGeometry(QRect(40, 260, 231, 61));
...
"}"));
        ...
        pushButton->setGeometry(QRect(310, 370, 111, 51));
...
""));
        ...
        savingLineEdit->setGeometry(QRect(270, 270, 281, 41));
...
"    }"));
        ...
        monthlyIncomeLineEdit->setGeometry(QRect(260, 170, 281, 41));
